          ...
          <div className="max-w-4xl">
            ...
            <p className="text-base text-gray-300 mb-6 leading-relaxed max-w-3xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-12">
                <button className="bg-transparent text-white px-6 py-3 rounded-full text-sm font-semibold hover:bg-white hover:text-black transition-colors border border-white">
                  Start Free Trial
                </button>
                <button className="bg-transparent text-gray-300 px-6 py-3 rounded-full text-sm font-semibold hover:text-white transition-colors border border-gray-600">
                  Watch Demo
                </button>
              </div>
